...
public class MixingDesk {
	...
	private static boolean speakingActive1 = false, speakingActive2 = false, pflActive = false, cartwallActive = false, monitorMuted = false;
	...
	public void activatePhonesNormal() {
		phones.muteSingle(0);
		phones.muteSingle(1);
		phones.muteSingle(2);
		phones.muteSingle(3);
	...
	private void setSpeakingAktive(int microphoneNumber, boolean speakingActive) {
		if (speakingActive) {
			...
			MixingDesk.speakingActive2 = speakingActive1;
			deactivateMicrophones(microphoneNumber);
			if (!speakingActive1 && !speakingActive2)
